...
class BEiT3ForCaptioning(BEiT3Wrapper):
    ...
    def forward(
        self, image, text_ids, padding_mask, language_masked_pos, text_len=None, incremental_state=None, **kwargs
    ):
...
class BEiT3ForRetrieval(BEiT3Wrapper):
    def __init__(self, args, **kwargs):
        ...
        self.criterion = beit3_utils.ClipLoss(
            rank=beit3_utils.get_rank(),
            world_size=beit3_utils.get_world_size(),
        )
